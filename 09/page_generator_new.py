...
def read_json_data():
    with open('Lekce 08/data.json', encoding='utf-8') as file:
        return json.load(file)

def read_template():
    with open('Lekce 09/list.html', encoding='utf-8') as file:
        return file.read()

def save_html(html):
    with open('Lekce 09/list3.html', mode='w', encoding='utf-8') as file:
        file.write(html)
