...
#DATA_PATH1 = '/Users/denisovdaniil/Library/Mobile Documents/com~apple~CloudDocs/itstep/Python/Lekce 03/users.json'
#DATA_PATH2 = 'users.json'

import os, json, hashlib

#print(os.path.isfile(DATA_PATH1))


DATA_PATH = 'Lekce 03/users.json'
...
def change_password(username, old_password, password, password_repeat):
    ...
    if username in data and data[username] == old_password:
        ...
        raise ValueError('Uživatel neexistuje nebo špatné heslo')
